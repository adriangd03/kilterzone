...
<div class="container mt-5">
    <div class="row">
        <div class="col-12">
            <h1 class="fs-2">{{$ruta->nom_ruta}} {{$ruta->dificultat}} {{$ruta->inclinacio}} {{ $ruta->layout }}</h1>
        </div>
    </div>
    <hr class="mb-4">
    <div class="row">
        ...
        <div class="col-md-6 col-12">
            <div class="card">
                <div class="card-header justify-content-between d-flex align-items-center">
                    ...
                    <div>
                        <button class="btn rounded-circle border-dark p-0 ps-1 pe-1 text-center" type="button" data-bs-toggle="modal" data-bs-target="#eliminarRutaModal"><i class="bi bi-three-dots"></i><span class="visually-hidden">Opcions</span></button>
                    </div>
                </div>
...
@endif
@if($ruta->user_id === Auth::user()->id)
<div class="modal fade" id="eliminarRutaModal" tabindex="-1" aria-labelledby="modalAvatarLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header ">
                <h4 class="modal-title m-auto" id="modalAvatarLabel">Eliminar Ruta</h4>

            </div>
            <div class="modal-body p-0">
              
                <form method="POST" name="formEliminarRuta"  action="{{ route('ruta.eliminar') }}">
                    @csrf
                    <input type="hidden" id="eliminarRutaModal" name="rutaId" value="{{ $ruta->id }}">
                    <button id="" type="submit" class="btn rounded-0 btn-light  text-danger w-100 border border-bottom user-hover pt-3 pb-3 fs-5 p-1 text-center mt-0">Eliminar ruta</button>
                </form>
